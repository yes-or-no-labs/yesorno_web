    ...
    <div class="w-full flex flex-col gap-[20px]">
        <div class="flex justify-between items-center w-full">
            <div class="flex items-center gap-[10px] flex-1 h-[48px]">
                <div class="bg-[#6DDD2526] w-[48px] h-[48px] rounded-[4px] flex items-center justify-center">
        ...
        <div class="flex items-center gap-[20px]">
            <div class="flex-1 border border-solid !border-[#FFFFFF80] rounded-[4px] !px-[10px] !py-[20px] flex flex-col gap-[10px]">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-[5px]">
                        <div class="bg-[#0AB45A26] flex items-center justify-center rounded-[4px] w-[48px] h-[48px]">
                    ...
                    <div class="!px-[8px] !p-[4px] rounded-full bg-[#666] text-[#fff] text-[14px] leading-[14px]">OKX</div>
                </div>
                <div class="flex flex-col">
        ...
        <div class="flex items-center gap-[20px]">
            <div class="flex-[0.7] border border-solid !border-[#FFFFFF80] rounded-[4px] !p-[10px] flex gap-[10px]">
                <div>
                    <div class="w-[160px] h-[160px] rounded-full border-[2px] border-solid border-[#0AB45A]">
                        <div class="w-full h-full rounded-full border-[4px] border-solid border-[#000]">
                            <div class="w-full h-full rounded-full" style="border: 2px solid rgba(10, 180, 90, .5);">
                                <div class="w-full h-full rounded-full bg-[#535353] !p-[2px] flex items-center justify-center relative overflow-hidden">
                ...
                <div class="flex flex-col gap-[10px] flex-1">
                    <div class=" grid grid-cols-2 gap-x-[5px] gap-y-[15px]">
                        <div class="!px-[10px] h-[52px] rounded-[6px] border border-solid !border-[#FFFFFF80] flex items-center justify-between" v-for="item in 6">
                            <div class="text-[12px] text-[#fff]">RSI14 Overbought (65.9)</div>
                            <div class="!px-[10px] !py-[5px] text-[#fff] text-[14px] bg-[#666] rounded-full">22%</div>
                        </div>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-[10px]">
                            <div class="!px-[10px] !py-[5px] border border-solid !border-[#0AB45A] text-[#0AB45A] text-[12px] flex items-center rounded-full gap-[5px]">
                                <img src="@/assets/img/ai_icon4.png" class="w-[14px] h-[14px]">
                                Bullish
                            </div>
                            <div class="text-[#fff] text-[14px]">Risk level: <span class="text-[#E72F2F]">High risk</span></div>
                        </div>
                        <VBtnConnect> Save prediction </VBtnConnect>
                    </div>
                </div>
            </div>
            <div class="flex-[0.3] border border-solid !border-[#FFFFFF80] rounded-[4px] !p-[10px] h-[275px]">
                <div class="flex items-center gap-[5px]">
                 ...
                 <div class="h-[200px] overflow-y-auto">
                    <div class="!py-[15px] !px-[5px] flex items-center border-b border-solid !border-[#FFFFFF80]" v-for="item in 10">
                        ...
                        <div class="flex-1 text-[12px] text-[#fff] flex items-center">
                            2025/7/14 14:48:39
                        </div>
                        <div class="flex-1 text-[12px] flex items-center">
