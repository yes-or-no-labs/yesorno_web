            ...
            <div class="!p-[16px]">
              <div class="relative flex justify-center items-center w-[240px] h-[65px] mx-auto">
                ...
                <div class="relative z-10 flex flex-col items-center justify-center w-full">
                  <div class="text-[16px]" :style="`color:${props.item?.lockPriceCom<props.item?.endPriceCom?'#0AB45A':'#fff'}`">UP</div>
              ...
              <div class="relative flex justify-center items-center w-[240px] h-[65px] mx-auto">
                ...
                <div class="relative z-10 flex flex-col items-center justify-center w-full">
                  <div class="text-[12px] text-[#fff]">2.61x Payout</div>
                  <div class="text-[16px]" :style="`color:${props.item?.lockPriceCom<props.item?.endPriceCom?'#fff':'#E72F2F'}`">DOWN</div>
                </div>
              </div>
            </div>
          </div>
